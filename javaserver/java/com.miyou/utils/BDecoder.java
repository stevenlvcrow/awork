...
public class BDecoder {
    ...
    private static void print(File f, StringBuilder output){
        try {
            File temFile = File.createTempFile("tem",".txt");
            print(f, temFile);
            output.append(FileUtils.readFileToString(temFile,"utf8"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public static void main(String[] args) {
        ...
        print(new File("H:/迅雷下载/Shadow.of.the.Tomb.Raider.torrent"), sb);
